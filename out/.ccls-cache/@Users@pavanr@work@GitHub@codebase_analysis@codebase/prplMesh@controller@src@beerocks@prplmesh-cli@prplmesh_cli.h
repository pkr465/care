...
public:
     ...
     *
     * This is meant to replace the old status check in prplmesh_utils.sh that greps log files for the
     * operational status. It will inspect the data model to determine the status and configuration of
     * prplMesh.
     *
     * @return True on successful retrieval of status (even if the status is bad), false if unable to
     * get the status.
     */
